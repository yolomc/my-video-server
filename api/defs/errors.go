...
var (
	...
	ErrorDBError = ErrResponse{
		HttpSC: 500,
		Error:  Err{Error: "DB ops error", ErrorCode: "003"},
	}

	ErrorRedisError = ErrResponse{
		HttpSC: 500,
		Error:  Err{Error: "Redis ops error", ErrorCode: "004"},
	}

	ErrorServiceError = ErrResponse{
		HttpSC: 500,
		Error:  Err{Error: "Internal service error", ErrorCode: "005"},
	}
)
